      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <Popover.Group as="nav" className="hidden md:flex space-x-10">
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      'group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#d83d2e]'
                    )}
                  >
                    <span>Solutions</span>
                    <ChevronDownIcon
            ...
            <Link to="/addanonnce" className="text-base font-medium text-gray-500 hover:text-gray-900">
              Ajouter annonce
            </Link>
            <Link to="/addcategory" className="text-base font-medium text-gray-500 hover:text-gray-900">
              Ajouter catégorie
            </Link>
